...
import { g as getPublicPage, l as listPublicProducts, h as heroBg } from "./router-CPmUjF1E.mjs";
import "../_libs/seroval.mjs";
import { S as Sparkles, A as ArrowRight, B as Boxes, Q as Quote, W as Workflow, P as PlugZap, b as Lightbulb, c as LifeBuoy, d as Layers, e as Bot } from "../_libs/lucide-react.mjs";
...
function Icon({
  ...
  const I = name && dynamicIcons[name] || Boxes;
...
function PublicHomeLink({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: to, className, children });
}
function Home() {
  const {
    data: pageRow
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 pt-24 pb-28 md:pt-24 md:pb-36", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl text-center animate-fade-up", children: [
          ...
          hero.ctas && hero.ctas.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap items-center justify-center gap-3", children: hero.ctas.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicHomeLink, { to: c.to, className: c.variant === "secondary" ? "inline-flex items-center gap-2 rounded-md border border-border bg-surface/60 px-5 py-3 text-sm font-medium backdrop-blur hover:bg-surface" : "inline-flex items-center gap-2 rounded-md bg-gradient-brand px-5 py-3 text-sm font-medium text-brand-foreground shadow-glow transition-transform hover:-translate-y-0.5", children: [
            c.label,
            " ",
    ...
    (finalCta.title || finalCta.ctas && finalCta.ctas.length > 0) && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-6 pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-3xl border border-border bg-surface p-10 text-center md:p-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        finalCta.ctas && finalCta.ctas.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap items-center justify-center gap-3", children: finalCta.ctas.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicHomeLink, { to: c.to, className: c.variant === "secondary" ? "inline-flex items-center gap-2 rounded-md border border-border bg-surface/60 px-6 py-3 text-sm font-medium backdrop-blur hover:bg-surface" : "inline-flex items-center gap-2 rounded-md bg-gradient-brand px-6 py-3 text-sm font-medium text-brand-foreground shadow-glow", children: [
          c.label,
          " ",
          c.variant !== "secondary" && /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4" })
        ] }, c.label)) })
