...
function CookiesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LegalPage, { title: page?.title ?? "Política de Cookies", lead: c.lead ?? page?.excerpt ?? "Uso de cookies neste site.", children: (c.sections ?? []).map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
